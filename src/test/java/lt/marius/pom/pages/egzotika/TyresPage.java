...
public class TyresPage {
    ...
    public static void clickOnMenuItemTyres() {
        Common.clickOnElementByAction(Locators.Egzotika.Tyres.menuItemTyres);
    }
    ...
    public static List<String> readFoundTyresSeason() {
        return Common.getTextFromElements(Locators.Egzotika.Tyres.tyresSizeSeason);
    }
}